...
def main():
    ...
    csv_path = '/Users/pocketfm/Documents/book-research-tool/New genre crawl/Political Drama_Romance_combined_raw.csv'
    if os.path.exists(csv_path):
        df = pd.read_csv(csv_path)
    else:
        df = pd.read_csv('/Users/pocketfm/Documents/book-research-tool/New genre crawl/Political Drama_Romance_enriched.csv')
    ...
    if missing_books_rows:
        ...
        out_path = '/Users/pocketfm/Documents/book-research-tool/New genre crawl/Political Drama_Romance_full_scout_discovery.csv'
