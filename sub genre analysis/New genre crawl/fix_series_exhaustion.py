...
async def main():
    enriched_path = '/Users/pocketfm/Documents/book-research-tool/New genre crawl/Political Drama_Romance_enriched.csv'
    ...
    if missing_records:
        ...
        out_path = '/Users/pocketfm/Documents/book-research-tool/New genre crawl/Political Drama_Romance_series_exhaustion_discovery.csv'
