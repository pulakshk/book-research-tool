...
def main():
    csv_path = '/Users/pocketfm/Documents/book-research-tool/New genre crawl/Political Drama_Romance_enriched.csv'
    ...
    filtered_df.to_csv('/Users/pocketfm/Documents/book-research-tool/New genre crawl/Political Drama_Romance_enriched_filtered.csv', index=False)
    
    excluded_df = df[~df['Is Relevant']].drop(columns=['id', 'Is Relevant'])
    excluded_df.to_csv('/Users/pocketfm/Documents/book-research-tool/New genre crawl/Political Drama_Romance_excluded.csv', index=False)
